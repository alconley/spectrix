...
pub fn add_histograms(lf: LazyFrame) -> Result<Histogrammer, PolarsError> {
    ...
    */
    ...
    let lf = lf.with_columns(vec![
        (lit(-2.72156900878375e-19)*col("Cebra0Energy")*col("Cebra0Energy") + lit(1.0) *col("Cebra0Energy") + lit(-5.6843418860808e-14)).alias("Cebra0EnergyGM"),
        (lit(-4.97165415075812e-06)*col("Cebra1Energy")*col("Cebra1Energy") + lit(1.14338957961188)*col("Cebra1Energy") + lit(-0.445011719623494)).alias("Cebra1EnergyGM"),
        (lit(-2.35730449363139e-05)*col("Cebra2Energy")*col("Cebra2Energy") + lit(0.996173496729512)*col("Cebra2Energy") + lit(1.7443869915702)).alias("Cebra2EnergyGM"),
        (lit(-1.32712886414671e-05)*col("Cebra3Energy")*col("Cebra3Energy") + lit(0.999818365276875)*col("Cebra3Energy") + lit(0.941072453624997)).alias("Cebra3EnergyGM"),
        (lit(-2.76775763630926e-05)*col("Cebra4Energy")*col("Cebra4Energy") + lit(0.860232802761158)*col("Cebra4Energy") + lit(-0.459548374380745)).alias("Cebra4EnergyGM"),
        (lit(-2.22330292983274e-05)*col("Cebra5Energy")*col("Cebra5Energy") + lit(1.2289729811605)*col("Cebra5Energy") + lit(0.283037829606826)).alias("Cebra5EnergyGM"),
        (lit(-4.12687972463716e-07)*col("Cebra6Energy")*col("Cebra6Energy") + lit(0.701053103610418)*col("Cebra6Energy") + lit(0.211631359048795)).alias("Cebra6EnergyGM"),
        (lit(-3.57953438680052e-05)*col("Cebra7Energy")*col("Cebra7Energy") + lit(1.29207015301957)*col("Cebra7Energy") + lit(1.07805724372673)).alias("Cebra7EnergyGM"),
        (lit(-3.03544968865592e-05)*col("Cebra8Energy")*col("Cebra8Energy") + lit(0.957884129953653)*col("Cebra8Energy") + lit(-1.25796690476597)).alias("Cebra8EnergyGM"),
    ...
    for i in 0..9 {
        ...
        h.fill_hist2d(&format!("CeBrA vs Xavg: Energy Calibrated"), &time_cut_lf[i], "XavgEnergyCalibrated", &format!("Cebra{}EnergyECal", i));
    }
