...
pub fn sps_histograms(h: &mut Histogrammer, lf: LazyFrame) {
    ...
    let lf_bothplanes = lf_sps
        .clone()
        .filter(col("X1").neq(lit(-1e6)))
        .filter(col("X2").neq(lit(-1e6)));
    let lf_only_x1_plane = lf_sps
        .clone()
        .filter(col("X1").neq(lit(-1e6)))
        .filter(col("X2").eq(lit(-1e6)));
    let lf_only_x2_plane = lf_sps
        .clone()
        .filter(col("X2").neq(lit(-1e6)))
    ...
    h.add_fill_hist1d(
        "SE-SPS/Focal Plane/X1: only1plane",
        &lf_only_x1_plane,
        "X1",
        600,
        (-300.0, 300.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Focal Plane/X1: bothplanes",
        &lf_bothplanes,
        "X1",
        600,
        (-300.0, 300.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Focal Plane/X2: only1plane",
        &lf_only_x2_plane,
        "X2",
        600,
        (-300.0, 300.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Focal Plane/X2: bothplanes",
        &lf_bothplanes,
        "X2",
        600,
        (-300.0, 300.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Focal Plane/Xavg: bothplanes",
        &lf_bothplanes,
        "Xavg",
        600,
        (-300.0, 300.0),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Focal Plane/Theta v Xavg: bothplanes",
        &lf_bothplanes,
        "Xavg",
        "Theta",
        (600, 300),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification/AnodeBack v ScintLeft",
        &lf_sps,
        "ScintLeftEnergy",
        "AnodeBackEnergy",
        (512, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification/AnodeFront v ScintLeft",
        &lf_sps,
        "ScintLeftEnergy",
        "AnodeFrontEnergy",
        (512, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification/Cathode v ScintLeft",
        &lf_sps,
        "ScintLeftEnergy",
        "CathodeEnergy",
        (512, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification/AnodeBack v ScintRight",
        &lf_sps,
        "ScintRightEnergy",
        "AnodeBackEnergy",
        (512, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification/AnodeFront v ScintRight",
        &lf_sps,
        "ScintRightEnergy",
        "AnodeFrontEnergy",
        (512, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification/Cathode v ScintRight",
        &lf_sps,
        "ScintRightEnergy",
        "CathodeEnergy",
        (512, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/ScintLeft v X1",
        &lf_sps,
        "X1",
        "ScintLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/ScintLeft v X2",
        &lf_sps,
        "X2",
        "ScintLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/ScintLeft v Xavg",
        &lf_sps,
        "Xavg",
        "ScintLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/ScintRight v X1",
        &lf_sps,
        "X1",
        "ScintRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/ScintRight v X2",
        &lf_sps,
        "X2",
        "ScintRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/ScintRight v Xavg",
        &lf_sps,
        "Xavg",
        "ScintRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/AnodeBack v X1",
        &lf_sps,
        "X1",
        "AnodeBackEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/AnodeBack v X2",
        &lf_sps,
        "X2",
        "AnodeBackEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/AnodeBack v Xavg",
        &lf_sps,
        "Xavg",
        "AnodeBackEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/AnodeFront v X1",
        &lf_sps,
        "X1",
        "AnodeFrontEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/AnodeFront v X2",
        &lf_sps,
        "X2",
        "AnodeFrontEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/AnodeFront v Xavg",
        &lf_sps,
        "Xavg",
        "AnodeFrontEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/Cathode v X1",
        &lf_sps,
        "X1",
        "CathodeEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/Cathode v X2",
        &lf_sps,
        "X2",
        "CathodeEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Particle Identification v Focal Plane/Cathode v Xavg",
        &lf_sps,
        "Xavg",
        "CathodeEnergy",
        (600, 512),
    ...
    let lf_time_rel_backanode = lf_sps
        .clone()
        .filter(col("AnodeBackTime").neq(lit(-1e6)))
        .filter(col("ScintLeftTime").neq(lit(-1e6)));
    h.add_fill_hist1d(
        "SE-SPS/Timing/AnodeFrontTime-AnodeBackTime",
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/AnodeBackTime-AnodeFrontTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/AnodeFrontTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/AnodeBackTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/DelayFrontLeftTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/DelayFrontRightTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/DelayBackLeftTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/DelayBackRightTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/ScintRightTime-ScintLeftTime",
        &lf_time_rel_backanode,
    ...
    h.add_fill_hist2d(
        "SE-SPS/Timing/ScintTimeDif v Xavg",
        &lf_time_rel_backanode,
        "Xavg",
        "ScintRightTime_ScintLeftTime",
        (600, 12800),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayFrontRight v X1",
        &lf_sps,
        "X1",
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayFrontLeft v X1",
        &lf_sps,
        "X1",
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayBackRight v X2",
        &lf_sps,
        "X2",
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayBackLeft v X2",
        &lf_sps,
        "X2",
        "DelayBackLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayBackRight v Xavg",
        &lf_sps,
        "Xavg",
        "DelayBackRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayBackLeft v Xavg",
        &lf_sps,
        "Xavg",
        "DelayBackLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayFrontRight v Xavg",
        &lf_sps,
        "Xavg",
        "DelayFrontRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayFrontLeft v Xavg",
        &lf_sps,
        "Xavg",
        "DelayFrontLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayBackRight v X1",
        &lf_sps,
        "X1",
        "DelayBackRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayBackLeft v X1",
        &lf_sps,
        "X1",
        "DelayBackLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayFrontRight v X2",
        &lf_sps,
        "X2",
        "DelayFrontRightEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/DelayFrontLeft v X2",
        &lf_sps,
        "X2",
        "DelayFrontLeftEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/Averages/DelayFrontAverage v X1",
        &lf_sps,
        "X1",
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/Averages/DelayBackAverage v X1",
        &lf_sps,
        "X1",
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/Averages/DelayFrontAverage v X2",
        &lf_sps,
        "X2",
        "DelayFrontAverageEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/Averages/DelayBackAverage v X2",
        &lf_sps,
        "X2",
        "DelayBackAverageEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/Averages/DelayFrontAverage v Xavg",
        &lf_sps,
        "Xavg",
        "DelayFrontAverageEnergy",
        (600, 512),
    ...
    h.add_fill_hist2d(
        "SE-SPS/Delay Lines v Focal Plane/Averages/DelayBackAverage v Xavg",
        &lf_sps,
        "Xavg",
        "DelayBackAverageEnergy",
        (600, 512),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Bothplanes/DelayFrontLeftTime-AnodeFrontTime: bothplanes",
        &lf_bothplanes,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Bothplanes/DelayFrontRightTime-AnodeFrontTime: bothplanes",
        &lf_bothplanes,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Bothplanes/DelayBackLeftTime-AnodeBackTime: bothplanes",
        &lf_bothplanes,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Bothplanes/DelayBackRightTime-AnodeBackTime: bothplanes",
        &lf_bothplanes,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayFrontLeftTime-AnodeFrontTime: onlyX1",
        &lf_only_x1_plane,
        "DelayFrontLeftTime_AnodeFrontTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayFrontRightTime-AnodeFrontTime: onlyX1",
        &lf_only_x1_plane,
        "DelayFrontRightTime_AnodeFrontTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayBackLeftTime-AnodeFrontTime: onlyX1",
        &lf_only_x1_plane,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayBackRightTime-AnodeFrontTime: onlyX1",
        &lf_only_x1_plane,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayFrontLeftTime-AnodeBackTime: onlyX1",
        &lf_only_x1_plane,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayFrontRightTime-AnodeBackTime: onlyX1",
        &lf_only_x1_plane,
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayBackLeftTime-AnodeBackTime: onlyX1",
        &lf_only_x1_plane,
        "DelayBackLeftTime_AnodeBackTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X1/DelayBackRightTime-AnodeBackTime: onlyX1",
        &lf_only_x1_plane,
        "DelayBackRightTime_AnodeBackTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayFrontLeftTime-AnodeFrontTime: onlyX2",
        &lf_only_x2_plane,
        "DelayFrontLeftTime_AnodeFrontTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayFrontRightTime-AnodeFrontTime: onlyX2",
        &lf_only_x2_plane,
        "DelayFrontRightTime_AnodeFrontTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayBackLeftTime-AnodeFrontTime: onlyX2",
        &lf_only_x2_plane,
        "DelayBackLeftTime_AnodeFrontTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayBackRightTime-AnodeFrontTime: onlyX2",
        &lf_only_x2_plane,
        "DelayBackRightTime_AnodeFrontTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayFrontLeftTime-AnodeBackTime: onlyX2",
        &lf_only_x2_plane,
        "DelayFrontLeftTime_AnodeBackTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayFrontRightTime-AnodeBackTime: onlyX2",
        &lf_only_x2_plane,
        "DelayFrontRightTime_AnodeBackTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayBackLeftTime-AnodeBackTime: onlyX2",
        &lf_only_x2_plane,
        "DelayBackLeftTime_AnodeBackTime",
        8000,
        (-4000.0, 4000.0),
    ...
    h.add_fill_hist1d(
        "SE-SPS/Timing/Only X2/DelayBackRightTime-AnodeBackTime: onlyX2",
        &lf_only_x2_plane,
        "DelayBackRightTime_AnodeBackTime",
        8000,
        (-4000.0, 4000.0),
...
pub fn pips1000(h: &mut Histogrammer, lf: LazyFrame) {
    let lf_pips = lf.with_columns(vec![
        ...
        (lit(-1.77049e-06) * col("PIPS1000Energy") * col("PIPS1000Energy")
            + lit(0.544755003513083) * col("PIPS1000Energy")
            + lit(-1.36822594543883))
    ...
    h.add_fill_hist1d(
        "PIPS1000: Energy Calibrated",
        &lf_pips,
        "PIPS1000EnergyCalibrated",
        600,
        (0.0, 1200.0),
    );
}
...
pub fn cebra(
    h: &mut Histogrammer,
    lf: LazyFrame,
    detector_number: usize,
    timecut: Option<TimeCut>,
    gainmatch: Option<GainMatch>,
) {
    ...
    let lf_cebra = lf_cebra.with_column(
        ((col(&format!("Cebra{}Energy", i)) - col(&format!("Cebra{}Short", i)))
            / col(&format!("Cebra{}Energy", i)))
        .alias(&format!("Cebra{}PSD", i)),
    );

    h.add_fill_hist1d(
        &format!("CeBrA/Cebra{}/Cebra{}Energy", i, i),
        &lf_cebra,
        &format!("Cebra{}Energy", i),
        512,
        (0.0, 4096.0),
    ...
    h.add_fill_hist2d(
        &format!("CeBrA/Cebra{}/PSD v Energy", i),
        &lf_cebra,
        &format!("Cebra{}Energy", i),
        &format!("Cebra{}PSD", i),
        (512, 512),
    ...
    let lf_cebra = if let Some(ref gainmatch) = &gainmatch {
        ...
        h.add_fill_hist1d(
            &format!("CeBrA/Cebra{}/Cebra{}EnergyGM", i, i),
            &lf,
            &format!("Cebra{}EnergyGM", i),
            512,
            (0.0, 4096.0),
    ...
    let lf_cebra = if column_names.contains(&"ScintLeftTime".to_string()) {
        ...
        if !column_names.contains(&format!("Cebra{}RelTime", i)) {
            lf_cebra.with_column(
                (col(&format!("Cebra{}Time", i)) - col("ScintLeftTime"))
                    .alias(&format!("Cebra{}RelTime", i)),
            )
        } else {
            lf_cebra
        }
    ...
    if sps {
        h.add_fill_hist1d(
            &format!("CeBrA/Cebra{}/Cebra{}RelTime", i, i),
            &lf_cebra,
            &format!("Cebra{}RelTime", i),
            3400,
            (-3200.0, 3200.0),
        );
        h.add_fill_hist2d(
            &format!("CeBrA/Cebra{}/Cebra{}Energy v Xavg", i, i),
            &lf_cebra,
            "Xavg",
            &format!("Cebra{}Energy", i),
            (600, 512),
        ...
        h.add_fill_hist2d(
            &format!("CeBrA/Cebra{}/Theta v Cebra{}RelTime ", i, i),
            &lf_cebra,
            &format!("Cebra{}RelTime", i),
            "Theta",
            (3400, 300),
            ((-3200.0, 3200.0), (0.0, PI)),
        );
    }
    ...
    if let Some(timecut) = timecut {
        if sps {
            ...
            let lf_timecut = lf_cebra
                .with_column(
                    (col(&format!("Cebra{}RelTime", i)) - lit(timecut.mean))
                        .alias(&format!("Cebra{}RelTimeShifted", i)),
                )
            ...
            h.add_fill_hist1d(
                &format!("CeBrA/Cebra{}/TimeCut/Cebra{}RelTime", i, i),
                &lf_timecut,
                &format!("Cebra{}RelTime", i),
                3400,
                (-3200.0, 3200.0),
            ...
            h.add_fill_hist1d(
                &format!("CeBrA/Cebra{}/TimeCut/Cebra{}RelTimeShifted", i, i),
                &lf_timecut,
                &format!("Cebra{}RelTimeShifted", i),
                100,
                (-50.0, 50.0),
            );
            h.add_fill_hist1d(
                &format!("CeBrA/Cebra{}/TimeCut/Cebra{}Energy", i, i),
                &lf_timecut,
                &format!("Cebra{}Energy", i),
                512,
                (0.0, 4096.0),
            ...
            h.add_fill_hist2d(
                &format!("CeBrA/Cebra{}/TimeCut/Cebra{}Energy v Xavg", i, i),
                &lf_timecut,
                "Xavg",
                &format!("Cebra{}Energy", i),
                (600, 512),
            ...
            h.add_fill_hist2d(
                &format!("CeBrA/Cebra{}/TimeCut/Cebra{}Energy v X1", i, i),
                &lf_timecut,
                "X1",
                &format!("Cebra{}Energy", i),
                (600, 512),
            ...
            if gainmatch.is_some() {
                h.add_fill_hist1d(
                    &format!("CeBrA/Cebra{}/TimeCut/GainMatched/Cebra{}EnergyGM", i, i),
                    &lf_timecut,
                    &format!("Cebra{}EnergyGM", i),
                    512,
                    (0.0, 4096.0),
                ...
                h.add_fill_hist2d(
                    &format!(
                        "CeBrA/Cebra{}/TimeCut/GainMatched/Cebra{}EnergyGM v Xavg",
                        i, i
                    ),
                    &lf_timecut,
                    "Xavg",
                ...
                h.add_fill_hist2d(
                    &"CeBrA/CebraEnergyGM v Xavg: TimeCut",
                    &lf_timecut,
                    "Xavg",
                    &format!("Cebra{}EnergyGM", i),
                    (600, 512),
                ...
                h.add_fill_hist2d(
                    &format!(
                        "CeBrA/Cebra{}/TimeCut/GainMatched/Cebra{}EnergyGM v X1",
                        i, i
                    ),
                    &lf_timecut,
                    "X1",
                ...
                h.add_fill_hist2d(
                    &"CeBrA/CebraEnergyGM v X1: TimeCut",
                    &lf_timecut,
                    "X1",
                    &format!("Cebra{}EnergyGM", i),
                    (600, 512),
